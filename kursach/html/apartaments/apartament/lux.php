    ...
    <section class="intro">
        <div class="wrapper_full">
            <div class="conteiner">
                <div class="imgs">
                    <div class="main_img">
                        <img src="img/lux/lux.jpeg" alt="Lux" class="lg-img">
                    </div>

                    <div class="other_img">
                        <img src="img/lux/lux2.jpeg" alt="Lux" class="sm-img">
                        <img src="img/lux/lux3.jpeg" alt="Lux" class="sm-img">
                        <img src="img/lux/lux4.jpeg" alt="Lux" class="sm-img">
                    </div>
                </div>
                <div class="booking">
                    <h3 class="intro_title">Люкс</h3>
                    <hr>
                    <p class="intro_more">Кровать размера king 200*200см с ортопедическим матрасом</p>
                    <p class="intro_more">Площадь номера: 80 кв.м.</p>
            ...
            <div class="conteiner">
                ...
                <div class="sale">
                    <figure class="information_card information_card_size">
                        <img src="img/lux/business.jpeg" alt="Business" class="information_card_pic">
            ...
            <div class="numbers_cards">
                <div class="numbers_card">
                    <div class="numbers_card_pic">
                        <img src="img/lux/standart_main.jpeg" alt="Standart" class="numbers_pic">
                    </div>
                ...
                <div class="numbers_card">
                    <div class="numbers_card_pic">
                        <img src="img/lux/delux.jpeg" alt="Delux" class="numbers_pic">
                    </div>
                    <div class="numbers_card_info">
                ...
                <div class="numbers_card">
                    <div class="numbers_card_pic">
                        <img src="img/lux/family.jpeg" alt="Family" class="numbers_pic">
                    </div>
                    <div class="numbers_card_info">
                ...
                <div class="numbers_card">
                    <div class="numbers_card_pic">
                        <img src="img/lux/business.jpeg" alt="Business" class="numbers_pic">
                    </div>
                    <div class="numbers_card_info">
