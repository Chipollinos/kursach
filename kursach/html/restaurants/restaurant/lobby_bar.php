                ...
                <div class="header_wrapper">
                    ...
                    <nav class="header_nav">
                        <ul class="header_list">
                            ...
                            <li class="header_item">
                                <a href="../restaurants.php" class="header_link">Рестораны и бары</a>
                            </li>
                            <li class="header_item">
    ...
    <section class="intro">
        <div class="wrapper_full">
            <div class="conteiner">
                <div class="imgs">
                    <div class="main_img">
                        <img src="img/lobby-bar/lobby-bar.jpeg" alt="Lobby Bar" class="lg-img">
                    </div>

                    <div class="other_img">
                        <img src="img/lobby-bar/lobby-bar2.jpeg" alt="Lobby Bar" class="sm-img">
                        <img src="img/lobby-bar/lobby-bar3.webp" alt="Lobby Bar" class="sm-img">
                        <img src="img/lobby-bar/lobby-bar4.jpeg" alt="Lobby Bar" class="sm-img">
                    </div>
                </div>
                <div class="booking">
                    <h3 class="intro_title">Лобби-бар</h3>
                    <p class="intro_more">+375 25 774 75 28</p>
                    <hr>
                    <p class="intro_more">11:00 – 23:00(Вс-Чт) и 11:00 – 24:00(Пт-Сб)</p>
                    <hr>
                </div>
            </div>
        </div>
            ...
            <div class="conteiner">
                <div class="more_information">
                    <div class="information_title">
                        <h3 class="information-title">Кафе «Оазис»</h3>
                    </div>
                    <p>В лобби-баре гости в приятной обстановке могут насладиться широким выбором алкогольных и безалкогольных напитков. <br>
                        Лобби-бар – идеальное место для проведения бизнес переговоров и дружеских встреч.</p>
                    <p>В летнее время года посетители могут разместиться на открытой террасе, любуясь красотами парковой зоны вокруг гостиницы. На террасе будем рады предложить Вам меню лобби-бара, а также меню кафе «Оазис».</p>
                </div>

                <div class="sale">
                    <figure class="information_card information_card_size">
                        <img src="img/lobby-bar/business.jpeg" alt="Business" class="information_card_pic">
    ...
    <section class="restaurant">
        <div class="wrapper_restaurant">
            <div class="restaurant_title">
                <h3 class="restaurant-title">Рестораны и бары</h3>
            </div>
            <div class="restaurant_cards">
                <div class="restaurant_card">
                    <div class="restaurant_card_pic">
                        <img src="img/lobby-bar/about_restaurant.jpeg" alt="Restaurant Seasons" class="restaurant_pic">
                    </div>
                    <div class="restaurant_card_info">
                        <p class="restaurant_info_name">Ресторан «Сезоны»</p>
                    </div>
                    <div class="restaurant_info_more">
                        <a href="restaurant_season.php" class="restaurant_button_more">ПОДРОБНЕЕ</a>
                    </div>
                </div>

                <div class="restaurant_card">
                    <div class="restaurant_card_pic">
                        <img src="img/lobby-bar/oazis1.jpeg" alt="Restaurant Oazis" class="restaurant_pic">
                    </div>
                    <div class="restaurant_card_info">
                        <p class="restaurant_info_name">Кафе «Оазис»</p>
                    </div>
                    <div class="restaurant_info_more">
                        <a href="restaurant_oazis.php" class="restaurant_button_more">ПОДРОБНЕЕ</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="wrapper_full">
            ...
            <nav class="footer_nav">
                <ul class="footer_list">
                    ...
                    <li class="footer_item">
                        <a href="../../../html/restaurants/restaurants.php" class="footer_link">Рестораны и бары</a>
                    </li>
                    <li class="footer_item">
